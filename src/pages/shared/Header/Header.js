                    ...
                    <nav className="flex justify-between bg-gray-900 text-white w-screen">
                        <div className="px-5 xl:px-12 py-6 flex w-full items-center">
                            <Link className="text-3xl font-bold font-heading" to="/">
                                <img className="h-9" src="http://getdrawings.com/vectors/web-logo-vector-36.jpg" alt="logo" />
                                {/* Logo Here. */}
                            </Link>
                            {/* <!-- Nav Links --> */}
                            <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
                                ...
                                <li><Link className="hover:text-gray-200" to="/contact-us">Contact Us</Link></li>
                                <li>
                                    {user?.displayName ? <Link className="hover:text-gray-200" to="/login" onClick={logOut}>LogOut</Link> :
                                        <span>
                                            <Link className="hover:text-gray-200" to="/login">Login</Link> / <Link className="hover:text-gray-200" to="/registration">Register</Link>
                                        </span>
                                    }
                                </li>
                            </ul>
                            ...
                            <div className="hidden xl:flex items-center space-x-5 items-center">
                                ...
                                <a className="flex items-center hover:text-gray-200" href="#profile">
                                    ...
                                    {!user.displayName ? <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 hover:text-gray-200" fill="none" viewBox="0 0 24 24" stroke="currentColor">
